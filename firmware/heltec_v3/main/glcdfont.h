...
/* Adafruit GFX glcdfont, 5x7 ASCII, BSD-licensed. Stripped of Arduino
 * conditionals and wrapped as a plain C++ header for ESP-IDF. */

static const unsigned char oled_font5x7[] = {
