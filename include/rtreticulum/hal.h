#ifndef RTRETICULUM_HAL_H
#define RTRETICULUM_HAL_H
...
void        rt_hal_mutex_lock(ur_mutex_t* m);
void        rt_hal_mutex_unlock(ur_mutex_t* m);
...
void                  rt_hal_recursive_mutex_lock(ur_recursive_mutex_t* m);
void                  rt_hal_recursive_mutex_unlock(ur_recursive_mutex_t* m);
